 ...
 */
class getGameSecurityVoterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'debug.security.voter.App\Security\Voter\GameSecurityVoter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'Voter'.\DIRECTORY_SEPARATOR.'GameSecurityVoter.php';

        $a = ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService());

        if (isset($container->privates['debug.security.voter.App\\Security\\Voter\\GameSecurityVoter'])) {
            return $container->privates['debug.security.voter.App\\Security\\Voter\\GameSecurityVoter'];
        }

        return $container->privates['debug.security.voter.App\\Security\\Voter\\GameSecurityVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(new \App\Security\Voter\GameSecurityVoter(), $a);
    }
}
