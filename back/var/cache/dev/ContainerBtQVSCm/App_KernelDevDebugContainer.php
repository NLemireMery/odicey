...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\Backoffice\\CharacterController' => 'getCharacterControllerService',
            'App\\Controller\\Backoffice\\GameController' => 'getGameControllerService',
            'App\\Controller\\Backoffice\\LoginController' => 'getLoginControllerService',
            'App\\Controller\\Backoffice\\LogoutController' => 'getLogoutControllerService',
            'App\\Controller\\Backoffice\\MainController' => 'getMainControllerService',
            'App\\Controller\\Backoffice\\ModeController' => 'getModeControllerService',
            'App\\Controller\\Backoffice\\UserController' => 'getUserControllerService',
            'App\\Controller\\CharacterController' => 'getCharacterController2Service',
            'App\\Controller\\GalleryController' => 'getGalleryControllerService',
            'App\\Controller\\GameController' => 'getGameController2Service',
            'App\\Controller\\ModeController' => 'getModeController2Service',
    ...
    protected function get_Container_Private_TwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Component\Mercure\Twig\MercureExtension($k, new \Symfony\Component\Mercure\Authorization($k, NULL), $b));
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('NGf5aRKy8S', 0, ($this->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('dd6miVLpnd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            ...
            'App\\Repository\\GameUsersRepository' => ['privates', 'App\\Repository\\GameUsersRepository', 'getGameUsersRepositoryService', true],
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('I5KpwMb2vL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('b8+-tQVJpa', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jQEZj+L2qe', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bKOn22CfrM', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('iAajC3zmuv', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger()))));
    }
    ...
    protected function getDebug_Security_Access_DecisionManagerService()
    {
        return $this->privates['debug.security.access.decision_manager'] = new \Symfony\Component\Security\Core\Authorization\TraceableAccessDecisionManager(new \Symfony\Component\Security\Core\Authorization\AccessDecisionManager(new RewindableGenerator(function () {
            ...
            yield 2 => ($this->privates['debug.security.voter.App\\Security\\Voter\\CharacterSecurityVoter'] ?? $this->load('getCharacterSecurityVoterService'));
            yield 3 => ($this->privates['debug.security.voter.App\\Security\\Voter\\GallerySecurityVoter'] ?? $this->load('getGallerySecurityVoterService'));
            yield 4 => ($this->privates['debug.security.voter.App\\Security\\Voter\\GameSecurityVoter'] ?? $this->load('getGameSecurityVoterService'));
            yield 5 => ($this->privates['debug.security.voter.App\\Security\\Voter\\UserSecurityVoter'] ?? $this->load('getUserSecurityVoterService'));
    ...
    {
        $a = new \Symfony\Component\Mercure\Jwt\LcobucciFactory((\dirname(__DIR__, 4).'/config/jwt/private.pem'), 'hmac.sha256', NULL, '');

        return $this->privates['mercure.hub.default.traceable'] = new \Symfony\Component\Mercure\Debug\TraceableHub(new \Symfony\Component\Mercure\Hub($this->getEnv('MERCURE_URL'), new \Symfony\Component\Mercure\Jwt\FactoryTokenProvider($a, [], []), $a, $this->getEnv('MERCURE_PUBLIC_URL'), ($this->privates['.debug.http_client'] ?? $this->get_Debug_HttpClientService())), ($this->privates['debug.stopwatch'] ?? ($this->privates['debug.stopwatch'] = new \Symfony\Component\Stopwatch\Stopwatch(true))));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'lexik_jwt_authentication.pass_phrase' => 'f5ac21fcb56e18415779d26961427676177d82635ea8cf8f97a76e09e46f4260',
