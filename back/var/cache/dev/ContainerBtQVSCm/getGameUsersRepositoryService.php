 ...
 */
class getGameUsersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\GameUsersRepository' shared autowired service.
     *
     * @return \App\Repository\GameUsersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'GameUsersRepository.php';

        return $container->privates['App\\Repository\\GameUsersRepository'] = new \App\Repository\GameUsersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
