 ...
 */
class getModeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ModeRepository' shared autowired service.
     *
     * @return \App\Repository\ModeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ModeRepository.php';

        return $container->privates['App\\Repository\\ModeRepository'] = new \App\Repository\ModeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
