 ...
 */
class getUserSecurityVoterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'debug.security.voter.App\Security\Voter\UserSecurityVoter' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Security'.\DIRECTORY_SEPARATOR.'Voter'.\DIRECTORY_SEPARATOR.'UserSecurityVoter.php';

        $a = ($container->services['event_dispatcher'] ?? $container->getEventDispatcherService());

        if (isset($container->privates['debug.security.voter.App\\Security\\Voter\\UserSecurityVoter'])) {
            return $container->privates['debug.security.voter.App\\Security\\Voter\\UserSecurityVoter'];
        }

        return $container->privates['debug.security.voter.App\\Security\\Voter\\UserSecurityVoter'] = new \Symfony\Component\Security\Core\Authorization\Voter\TraceableVoter(new \App\Security\Voter\UserSecurityVoter(), $a);
    }
}
