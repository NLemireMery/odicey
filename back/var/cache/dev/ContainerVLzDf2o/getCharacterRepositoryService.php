 ...
 */
class getCharacterRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CharacterRepository' shared autowired service.
     *
     * @return \App\Repository\CharacterRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CharacterRepository.php';

        return $container->privates['App\\Repository\\CharacterRepository'] = new \App\Repository\CharacterRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
