...
class __TwigTemplate_5c99cf05add54add250a0d84f21999c2cee8372e692217ab5884d896bfe44efd extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if ((isset($context["rounded"]) || array_key_exists("rounded", $context) ? $context["rounded"] : (function () { throw new RuntimeError('Variable "rounded" does not exist.', 10, $this->source); })())) {
            $context["classes"] = twig_array_merge((isset($context["classes"]) || array_key_exists("classes", $context) ? $context["classes"] : (function () { throw new RuntimeError('Variable "classes" does not exist.', 10, $this->source); })()), ["is-rounded"]);
        }
        // line 11
...
{% endif %}
", "@KnpPaginator/Pagination/bulma_pagination.html.twig", "C:\\wamp64\\www\\odicey\\back\\vendor\\knplabs\\knp-paginator-bundle\\templates\\Pagination\\bulma_pagination.html.twig");
    }
}
