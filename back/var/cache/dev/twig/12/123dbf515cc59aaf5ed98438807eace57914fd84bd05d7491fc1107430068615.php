...
class __TwigTemplate_a101936148ea01fdc70d70c976de34c44662ffeb829f7b655110dc2e269516f7 extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"text-end mb-3\">
        <a href=\"";
        // line 14
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_backoffice_user_getUsers", ["sort" => "id", "order" => ((((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 14, $this->source); })()), "request", [], "any", false, false, false, 14), "query", [], "any", false, false, false, 14), "get", ["sort"], "method", false, false, false, 14) == "id") && (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 14, $this->source); })()), "request", [], "any", false, false, false, 14), "query", [], "any", false, false, false, 14), "get", ["order"], "method", false, false, false, 14) == "asc"))) ? ("desc") : ("asc"))]), "html", null, true);
        echo "\" class=\"btn btn-outline-primary mx-1\">
            Trier par ID ";
        // line 15
        if (((isset($context["sort"]) || array_key_exists("sort", $context) ? $context["sort"] : (function () { throw new RuntimeError('Variable "sort" does not exist.', 15, $this->source); })()) == "id")) {
            if (((isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 15, $this->source); })()) == "asc")) {
        ...
        <a href=\"";
        // line 17
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_backoffice_user_getUsers", ["sort" => "email", "order" => ((((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 17, $this->source); })()), "request", [], "any", false, false, false, 17), "query", [], "any", false, false, false, 17), "get", ["sort"], "method", false, false, false, 17) == "email") && (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 17, $this->source); })()), "request", [], "any", false, false, false, 17), "query", [], "any", false, false, false, 17), "get", ["order"], "method", false, false, false, 17) == "asc"))) ? ("desc") : ("asc"))]), "html", null, true);
        echo "\" class=\"btn btn-outline-primary mx-1\">
            Trier par Email ";
        // line 18
        if (((isset($context["sort"]) || array_key_exists("sort", $context) ? $context["sort"] : (function () { throw new RuntimeError('Variable "sort" does not exist.', 18, $this->source); })()) == "email")) {
        ...
        <a href=\"";
        // line 20
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_backoffice_user_getUsers", ["sort" => "login", "order" => ((((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 20, $this->source); })()), "request", [], "any", false, false, false, 20), "query", [], "any", false, false, false, 20), "get", ["sort"], "method", false, false, false, 20) == "login") && (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 20, $this->source); })()), "request", [], "any", false, false, false, 20), "query", [], "any", false, false, false, 20), "get", ["order"], "method", false, false, false, 20) == "asc"))) ? ("desc") : ("asc"))]), "html", null, true);
        echo "\" class=\"btn btn-outline-primary mx-1\">
            Trier par Login ";
        // line 21
        if (((isset($context["sort"]) || array_key_exists("sort", $context) ? $context["sort"] : (function () { throw new RuntimeError('Variable "sort" does not exist.', 21, $this->source); })()) == "login")) {
            if (((isset($context["order"]) || array_key_exists("order", $context) ? $context["order"] : (function () { throw new RuntimeError('Variable "order" does not exist.', 21, $this->source); })()) == "asc")) {
                echo "<i class=\"bi bi-caret-up-fill\"></i>";
            } else {
                echo "<i class=\"bi bi-caret-down-fill\"></i>";
            }
    ...
    <!-- pagination -->
        ";
        // line 56
        $this->loadTemplate("backoffice/fragments/_pagination.html.twig", "backoffice/user/index.html.twig", 56)->display($context);
        // line 57
        echo "
";
    ...
    {
        return array (  220 => 57,  218 => 56,  212 => 52,  203 => 48,  194 => 44,  190 => 43,  185 => 41,  181 => 40,  177 => 39,  173 => 38,  170 => 37,  165 => 36,  149 => 23,  146 => 22,  138 => 21,  134 => 20,  131 => 19,  123 => 18,  119 => 17,  116 => 16,  108 => 15,  104 => 14,  98 => 11,  95 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% endblock %}
", "backoffice/user/index.html.twig", "C:\\wamp64\\www\\odicey\\back\\templates\\backoffice\\user\\index.html.twig");
    }
}
