...
class __TwigTemplate_21586f19fffc61a062541d606ae6732a81fa10eef1f4802582110b5d4d5d2b5b extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table table-hover\">
        ...
        echo "</td>
            ...
            ";
        // line 24
        if ((twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 24, $this->source); })()), "picture", [], "any", false, false, false, 24) != null)) {
            // line 25
            echo "            
                <tr class=\"table-active\">
        ...
        echo "
            ";
        // line 33
        if ((twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 33, $this->source); })()), "gamesDm", [], "any", false, false, false, 33) != null)) {
            // line 34
        ...
        echo "
            ";
        // line 49
        if ((twig_get_attribute($this->env, $this->source, (isset($context["user"]) || array_key_exists("user", $context) ? $context["user"] : (function () { throw new RuntimeError('Variable "user" does not exist.', 49, $this->source); })()), "characters", [], "any", false, false, false, 49) != null)) {
            // line 50
            echo "                ";
            $context['_parent'] = $context;
...
{% endblock %}", "backoffice/user/show.html.twig", "C:\\wamp64\\www\\odicey\\back\\templates\\backoffice\\user\\show.html.twig");
    }
}
