...
class __TwigTemplate_0470f746d28682050be6ad373265656e23329eaa596eb50706d80f7df0fe533f extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"text-end mb-3\">
        <a href=\"";
        // line 14
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_backoffice_mode_getModes", ["sort" => "id", "order" => ((((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 14, $this->source); })()), "request", [], "any", false, false, false, 14), "query", [], "any", false, false, false, 14), "get", ["sort"], "method", false, false, false, 14) == "id") && (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 14, $this->source); })()), "request", [], "any", false, false, false, 14), "query", [], "any", false, false, false, 14), "get", ["order"], "method", false, false, false, 14) == "asc"))) ? ("desc") : ("asc"))]), "html", null, true);
        ...
        <a href=\"";
        // line 17
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_backoffice_mode_getModes", ["sort" => "name", "order" => ((((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 17, $this->source); })()), "request", [], "any", false, false, false, 17), "query", [], "any", false, false, false, 17), "get", ["sort"], "method", false, false, false, 17) == "name") && (twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 17, $this->source); })()), "request", [], "any", false, false, false, 17), "query", [], "any", false, false, false, 17), "get", ["order"], "method", false, false, false, 17) == "asc"))) ? ("desc") : ("asc"))]), "html", null, true);
        echo "\" class=\"btn btn-outline-primary mx-1\">
            Trier par Name ";
        // line 18
    ...
    <table class=\"table table-hover\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["mode"]) {
            ...
            if (twig_get_attribute($this->env, $this->source, $context["mode"], "jsonstats", [], "any", false, false, false, 37)) {
                // line 38
                echo "                        ";
                $context["truncatedJsonstats"] = (twig_slice($this->env, json_encode(twig_get_attribute($this->env, $this->source, $context["mode"], "jsonstats", [], "any", false, false, false, 38)), 0, 50) . (((twig_length_filter($this->env, json_encode(twig_get_attribute($this->env, $this->source, $context["mode"], "jsonstats", [], "any", false, false, false, 38))) > 50)) ? ("...") : ("")));
                // line 39
                echo "                        ";
...
{% endblock %}
", "backoffice/mode/index.html.twig", "C:\\wamp64\\www\\odicey\\back\\templates\\backoffice\\mode\\index.html.twig");
    }
}
