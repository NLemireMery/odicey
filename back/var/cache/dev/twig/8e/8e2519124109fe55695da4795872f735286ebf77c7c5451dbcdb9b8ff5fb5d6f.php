...
class __TwigTemplate_64037936738cc916d9ff2331ef8d151aa37691319a052cfb72acc633acfc0afd extends Template
{
    private $source;
    private $macros = [];
    ...
    <a href=\"";
        ...
        echo "\" class=\"btn btn-outline-info mx-3 float-end\">Create new</a>
    <table class=\"table table-hover\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>";
            // line 25
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "login", [], "any", false, false, false, 25), "html", null, true);
            echo "</td>
                <td>";
            // line 26
            ...
            echo "</td>
                <td>
                    <a href=\"";
            // line 28
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_backoffice_user_show", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 28)]), "html", null, true);
            echo "\"><i class=\"bi bi-eye btn btn-sm btn-success rounded\"></i></a>
                    <a href=\"";
            // line 29
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_backoffice_user_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["user"], "id", [], "any", false, false, false, 29)]), "html", null, true);
...
";
    ...
    {
        return array (  155 => 37,  146 => 33,  137 => 29,  133 => 28,  128 => 26,  124 => 25,  120 => 24,  116 => 23,  113 => 22,  108 => 21,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    <a href=\"{{ path('app_backoffice_user_new') }}\" class=\"btn btn-outline-info mx-3 float-end\">Create new</a>
    <table class=\"table table-hover\">
        <thead>
            <tr>
                <th scope=\"col\">Id</th>
        ...
        {% for user in users %}
            <tr class=\"table-active\">
                ...
                <td>
                    <a href=\"{{ path('app_backoffice_user_show', {'id': user.id}) }}\"><i class=\"bi bi-eye btn btn-sm btn-success rounded\"></i></a>
                    <a href=\"{{ path('app_backoffice_user_edit', {'id': user.id}) }}\"><i class=\"bi bi-pencil btn btn-sm btn-warning rounded\"></i></a>
                </td>
            </tr>
        {% else %}
            <tr>
