...
class __TwigTemplate_c11a8cabc6145d7147559efc050ed95b3b9c95f9aa7b54b0192e92364cb841ac extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        // line 5
        echo "        ";
        if (twig_in_filter("backoffice", twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 5, $this->source); })()), "request", [], "any", false, false, false, 5), "get", ["_route"], "method", false, false, false, 5))) {
            // line 6
    ...
    {{ form_end(form) }}
</div>", "backoffice/game/_form.html.twig", "C:\\wamp64\\www\\odicey\\back\\templates\\backoffice\\game\\_form.html.twig");
    }
}
