...
class __TwigTemplate_ae43d6641ecd145852ccbd15316dd092ca60f29ebd8013a6ed7af9b7b82387cc extends Template
{
    private $source;
    private $macros = [];
    ...
    {{ form_start(form) }}
        ...
        <a href=\"{{ path('app_backoffice_game_list') }}\" class=\"btn btn-sm btn-outline-info mx-3 float-end\">Retour à la liste</a>
    {{ form_end(form) }}
