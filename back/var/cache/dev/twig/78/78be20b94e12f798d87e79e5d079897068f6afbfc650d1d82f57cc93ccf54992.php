...
class __TwigTemplate_fd5c3b55519c4f446f52a12c83047eb3b1f171a31a22b774837f07dc787f7188 extends Template
{
    private $source;
    private $macros = [];
            ...
            foreach ($context['_seq'] as $context["name"] => $context["data"]) {
                ...
                foreach ($context['_seq'] as $context["i"] => $context["message"]) {
                    ...
                    echo "</td>
                                    <td>";
                    // line 69
                    echo twig_var_dump($this->env, $context, ...[twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["message"], "object", [], "any", false, false, false, 69), "data", [], "any", false, false, false, 69)]);
                    echo "</td>
                                    <td>";
                    // line 70
                    echo twig_var_dump($this->env, $context, ...[twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["message"], "object", [], "any", false, false, false, 70), "private", [], "any", false, false, false, 70)]);
                    echo "</td>
                                    <td class=\"nowrap\">";
                    // line 71
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Mercure/Collector/mercure.html.twig", "C:\\wamp64\\www\\odicey\\back\\vendor\\symfony\\mercure-bundle\\src\\Resources\\views\\Collector\\mercure.html.twig");
    }
}
